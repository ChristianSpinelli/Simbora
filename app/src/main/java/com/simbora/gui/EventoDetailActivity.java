...
/**
 * An activity representing a single Evento detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link EventoListActivity}.
 * <p/>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link EventoDetailFragment}.
 */
public class EventoDetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(EventoDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(EventoDetailFragment.ARG_ITEM_ID));
